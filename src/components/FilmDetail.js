...
const films = {
  100: {
    ...
    acteurs:
      "George Babluani, Aurélien Recoing, Augustin Legrand, Philippe Passon",
    synopsis:
      "Quelque part, dans un endroit reculé au bord de la mer, Sébastien, 22 ans, répare le toit d'une maison. Le propriétaire meurt d'une overdose après avoir reçu une étrange convocation censée lui rapporter beaucoup d'argent. Sébastien récupère l'enveloppe et décide de prendre sa place...",
    avis:
  ...
  400: {
    ...
    acteurs:
      "Christian Clavier, Gérard Depardieu, Jamel Debbouze, Monica Bellucci, Alain Chabat, Claude Rich, Gérard Darmon, Edouard Baer, Dieudonné, Isabelle Nanty...",
    synopsis:
  ...
  420: {
    ...
    acteurs:
      "Audrey Hepburn, Peter Finch, Dame Edith Evans, Dame Peggy Ashcroft",
    synopsis:
  ...
  450: {
    ...
    avis:
      "Le troisième film de la 'trilogie de la mort' d'Alejandro Gonzalez Inarritu"
  },
  500: {
    titre: "Babysitting",
    ...
    acteurs:
      "Philippe Lacheau, Alcie David, Vincent Desagnat, Enzo Tomasini, Tarek Boudali, Julien Arruti",
    synopsis:
  ...
  1000: {
    ...
    avis:
      "Très beau film de SF qui pose de véritables questions sur l'attitude à adopter face aux progrès scientifiques."
  },
  1050: {
    titre: "Biutiful",
    image: "biutiful.jpg",
  ...
  1305: {
    ...
    acteurs:
      "Audrey Hepburn, William Holden, Grégoire Aslan, Raymond Bussières",
    synopsis:
  ...
  1320: {
    ...
    acteurs:
      "Jamie Foxx, Christophe Waltz, Leonardo DiCaprio, Samuel L. Jackson",
    synopsis:
      "Dans le sud des États-Unis, deux ans avant la guerre de Sécession, le Dr King Schultz, un chasseur de primes allemand, fait l’acquisition de Django, un esclave qui peut l’aider à traquer les frères Brittle, les meurtriers qu’il recherche. Schultz promet à Django de lui rendre sa liberté lorsqu’il aura capturé les Brittle – morts ou vifs.",
    avis:
      "Quentin Tarantino s'attaque à la question de l'esclavagisme et ça fait des étincelles."
  },
  1400: {
    ...
    synopsis:
      "Les crimes diaboliques du docteur Mabuse finalement capturé et enfermé dans un asile d'aliénés. Mais il continuera de sevir parmi les fous.",
    avis:
      "Le premier film de la trilogie de Fritz Lang consacré au Docteur Mabuse. Chef-d'oeuvre."
  },
  1500: {
    titre: "Dog Pound",
    image: "dog_pound.jpg",
  ...
  1600: {
    ...
    acteurs:
      "Ryan Gosling, Cary Mulligan, Bryan Cranston, Albert Brooks, Ron Perlman",
    synopsis:
  ...
  1775: {
    ...
    acteurs:
      "Clint Eastwood, Lee Van Cleef, Gian Maria Volonte, Mara Krupp, Luigi Pistilli",
    synopsis:
  ...
  1800: {
    ...
    avis:
      "Comment rendre une histoire captivante en filmant un homme qui regarde par la fenêtre chez ses voisins."
  },
  1900: {
    titre: "Fight Club",
  ...
  2300: {
    ...
    acteurs:
      "Sergeï Bondartchoik, Lioudmila Savelieva, Viatcheslav Tikhonov, Victor Stanitsyne",
    synopsis:
      "Apres la version de King Vidor, la campagne de Russie de Napoleon vue par les Russes. Oscar du meilleur film etranger.",
    avis:
      "Guerre et Paix de Tolstoï vu par les russes, cela donne une fresque grandiose."
  },
  2400: {
    titre: "Habemus papam",
  ...
  2600: {
    ...
    synopsis:
      "Tout commence par un chat entre deux internautes aux pseudonymes de Thonggrrrrrl14 et Lensman319. Les deux personnes, respectivement Hayley Stark, adolescente de quatorze ans et Jeff Kohlver, photographe de trente-deux ans, se mettent d'accord pour se donner rendez-vous.",
  ...
  3500: {
    ...
    synopsis:
      "VJack Skellington, roi des citrouilles et guide de Halloween-ville, s'ennuie : depuis des siècles, il en a assez de préparer la même fête de Halloween qui revient chaque année, et il rêve de changement. C'est alors qu'il a l'idée de s'emparer de la fête de Noël...",
  ...
  3800: {
    ...
    synopsis:
      "1942, au large de Bonifacio. La Wehrmacht a fait immerger de l'or et des documents classés secret défense. Les espions du monde entier convoîtent ce trésor. Les services secrets français font alors appel à leur meilleur agent, Dromart, alias 'Le Monocle'.",
    avis:
      "Le deuxième volet de la trilogie centrée sur le commandant Théobald Dromard dit Le Monocle."
  },
  3850: {
    ...
    acteurs:
      "Jean Gabin, Charles Vanel, Raymond Aimos, Charles Dorat, Raphaël Médina",
    synopsis:
  ...
  3900: {
    ...
    acteurs:
      "Alain Chabat, Chantal Lauby, Dominique Farrugia, Gérard Darmon, Sam Karmann",
    synopsis:
  ...
  4600: {
    ...
    acteurs:
      "Brigitte Bardot, Sami Frey, Marie-José Nat, Charles Vanel, Paul Meurisse",
    synopsis:
  ...
  4700: {
    ...
    avis:
      "Sergio Leone - Ennio Morricone. Le dernier film de la trilogie du dollar."
  },
  4750: {
    titre: "Le boucher",
  ...
  4900: {
    ...
    acteurs:
      "Kenneth Brannagh, Johnny Depp, Michelle Pfeiffer, Penelope Cruz, Willem Dafoe, Tom Bateman, Daisy Ridley",
    synopsis:
  ...
  5110: {
    ...
    acteurs:
      "Martin Freeman, Ian McKellen, Richard Armitage, Cate Blanchett, Elijah Wood",
    synopsis:
  ...
  5500: {
    ...
    acteurs:
      "Denis Podalydès, Pierre Arditi, Claude Rich, Sabine Azéma, Michael Lonsdale, Jean-Noël Brouté, Olivier Gourmet",
    synopsis:
  ...
  5600: {
    ...
    realisateur: "Bruno Podalydès",
    acteurs:
      "Denis Podalydès, Pierre Arditi, Claude Rich, Sabine Azéma, Michael Lonsdale, Jean-Noël Brouté, Olivier Gourmet, Zabou Breitman, Vincent Elbaz",
    synopsis:
  ...
  5630: {
    ...
    synopsis:
      "En 1945, à New York, les Corleone sont une des cinq familles de la mafia. Don Vito Corleone est le 'Parrain' de cette famille.",
  ...
  5632: {
    ...
    synopsis:
      "DAtteignant la soixantaine, Michael Corleone désire à la fois renouer avec les siens et se réhabiliter aux yeux de la société, surtout de l'Eglise.",
  ...
  5650: {
    ...
    acteurs:
      "Omar Sy, Fred Testot, Jonathan Lambert, Fanny Valette, Julie Ferrier, Pio Marmaï, Vincent Desagnat",
  ...
  5700: {
    ...
    acteurs:
      "Heather Donahue, Joshua Leonard, Michael C. Williams, Bob Griffith",
    synopsis:
      "En octobre 1994, trois jeunes cineastes, Heather Donahue, Joshua Leonard et Michael Williams, disparaissent en randonnee dans la foret de Black Hill au cours d'un reportage sur la sorcellerie. Un an plus tard, on a retrouve le film de leur enquete.",
  ...
  5900: {
    ...
    acteurs:
      "Matthew Broderick, James Earl Jones, Jeremy Irons, Nathan Lane, Rowan Atkinson, Woopi Goldberg",
    synopsis:
  ...
  6000: {
    ...
    realisateur: "Peter Jackson",
    acteurs:
      "Elijah Wood, Ian McKellen, Sean Astin, Viggo Mortensen, Andy Serkis, Orlando Bloom, Cate Blanchett, Liv Tyler",
    synopsis:
  ...
  6400: {
    ...
    synopsis:
      "Alors que le Docteur Mabuse est interné dans un asile psychiatrique, un gang de malfaiteurs sévit.",
  ...
  6500: {
    ...
    acteurs:
      "Yoshiko Shinohara, Ayano Shiraishi, Tsutomu Tatsumi, Akemi Yamaguchi",
    synopsis:
  ...
  6700: {
    ...
    avis:
      "Natalie Portmann toute jeune aux côtés de Jean Réno et Gary Oldman dans le rôle d'un flic pourri."
  },
  6800: {
  ...
  6900: {
    ...
    acteurs:
      "Christian Clavier, Thierry Lhermitte, Michel Blanc, Marie-Anne Chazel, Gérard Jugnot, Josiane Balasko, Luis Rego, Dominique Lavanant, Michel Creton, Martin Lamotte, Bruno Moynot",
    synopsis:
  ...
  7000: {
    ...
    realisateur: "Patrice Leconte",
    acteurs:
      "Christian Clavier, Thierry Lhermitte, Michel Blanc, Marie-Anne Chazel, Gérard Jugnot, Josiane Balasko, Dominique Lavanant, Maurice Chevit, Bruno Moynot",
    synopsis:
  ...
  7200: {
    ...
    acteurs:
      "Jacques Villeret, Jacques Gamblin, André Dussollier, Michel Serrault, Isabelle Carré, Eric Cantona, Marlène Baffier, Suzanne Flon",
    synopsis:
    ...
    avis:
      "La France rurale de l'entre-deux-guerres avec des acteur formidables."
  },
  7300: {
    ...
    realisateur: "Marcel Carné",
    acteurs:
      "Arletty, Jean-Louis Barrault, Maria Casarès, Pierre Brasseur, Marcel Herrand, Pierre Renoir",
    synopsis:
  ...
  7400: {
    ...
    realisateur: "Quentin Tarantino",
    acteurs:
      "Samuel L. Jackson, Kurt Russell, Jennifer Jason Leigh, Walton Goggins, Damian Bichir, Tim Roth, Michael Madsen, Bruce Dern, Channing Tatum",
    synopsis:
  ...
  7500: {
    ...
    acteurs:
      "Jack O'Connell, Rupert Friend, Ben Mendelsohn, Sam Spruell, Anthony Welsh",
    synopsis:
  ...
  7600: {
    ...
    realisateur: "Georges Lautner",
    acteurs:
      "Lino Ventura, Bernard Blier, Francis Blanche, Sabine Sinjen, Claude Rich, Robert Dalban, Jean Lefebvre",
    synopsis:
  ...
  7700: {
    ...
    acteurs:
      "Didier Bourdon, Pascal Légitimus, Bernard Campan, Antoine du Merle",
    synopsis:
  ...
  7830: {
    ...
    realisateur: "Julien Duvivier",
    acteurs:
      "Danielle Darrieux, Paul Meurisse, Bernard Blier, Lino Ventura, Paul Frankeur, Serge Reggiani, Robert Dalban",
    synopsis:
  ...
  8150: {
    ...
    realisateur: "Sergio Leone",
    acteurs:
      "Clint Eastwood, Gian Maria Volonte, Marianne Koch, Wolfgang Lukschy",
    synopsis:
  ...
  8200: {
    ...
    realisateur: "Quentin Tarantino",
    acteurs:
      "John Travolta, Samuel L. Jackson, Bruce Willis, Uma Thurman, Ving Rhames, Harvey Keitel, Tim Roth, Amanda Plummer",
    synopsis:
  ...
  8300: {
    ...
    acteurs:
      "Martina Garcia, Gustavo Sanchez Parra, Concha Velasco, Xabier Elorriaga",
    synopsis:
  ...
  8400: {
    ...
    acteurs:
      "Manuela Velasco, Pablo Rosso, Ferran Terraza, Jorge-Yamam Serrano",
    synopsis:
  ...
  9150: {
    ...
    realisateur: "Alain Chabat",
    acteurs:
      "Alain Chabat, Pio Marmaï, Golshifteh Farahani, Bruno Sanches, Audrey Tautou, Jean-Pierre Bacri, Patrick Timsit",
    synopsis:
  ...
  9300: {
    ...
    acteurs:
      "Neve Campbell, David Arquette, Courteney Cox, Rose McGowan, drew Barrymore",
    synopsis:
    ...
    avis:
      "Le premier film de la série consacrée au tueur au masque dans un campus universitaire."
  },
  9400: {
    titre: "Scream 2",
    image: "scream_2.jpg",
    ...
    realisateur: "Wes Craven",
    acteurs:
      "Neve Campbell, David Arquette, Courteney Cox, Sarah Michelle Gellar",
    synopsis:
  ...
  9700: {
    ...
    acteurs:
      "Isabelle Carré, Bernard Campan, Bernard Le Coq, Zabou, Anne Le Ny, Dominique Pinon",
    synopsis:
  ...
  10100: {
    ...
    realisateur: "Georges Lucas",
    acteurs:
      "Ewan McGregor, Natalie Portman, Hayden Christensen, Christopher Lee, Ian McDiamid, Samuel L. Jackson",
    synopsis:
  ...
  10200: {
    ...
    realisateur: "Georges Lucas",
    acteurs:
      "Ewan McGregor, Natalie Portman, Hayden Christensen, Ian McDiamid, Samuel L. Jackson",
    synopsis:
      "La Guerre des Clones fait rage. Une franche hostilité oppose désormais le Chancelier Palpatine au Conseil Jedi. Anakin Skywalker, jeune Chevalier Jedi pris entre deux feux, hésite sur la conduite à tenir. Séduit par la promesse d'un pouvoir sans précédent, tenté par le côté obscur de la Force, il prête allégeance au maléfique Darth Sidious et devient Dark Vador.",
    avis:
      "Troisième épisode de la trilogie prequel avec une première scène à couper le souffle."
  },
  10300: {
    ...
    realisateur: "Georges Lucas",
    acteurs:
      "Mark Hamill, Harrison Ford, Carrie Fisher, Peter Cushing, Anthony Daniels",
    synopsis:
  ...
  10700: {
    ...
    realisateur: "Rian Johnson",
    acteurs:
      "Daisy Ridley, John Boyega, Oscar Isaac, Adam Driver, Mark Hamill, Carrie Fisher",
    synopsis:
  ...
  10900: {
    ...
    realisateur: "Christopher Nolan",
    acteurs:
      "Christian Bale, Michael Caine, Gary Oldman, Anne Hathaway, Tom Hardy, Marion Cotillard, Joseph Gordon-Levitt, Morgan Freeman, Matthew Modine, Ben Mendelsohn, Liam Neeson",
    synopsis:
      "Il y a huit ans, Batman a disparu dans la nuit : lui qui était un héros est alors devenu un fugitif. S'accusant de la mort du procureur-adjoint Harvey Dent, le Chevalier Noir a tout sacrifié au nom de ce que le commissaire Gordon et lui-même considéraient être une noble cause. Et leurs actions conjointes se sont avérées efficaces pour un temps puisque la criminalité a été éradiquée à Gotham City grâce à l'arsenal de lois répressif initié par Dent.",
    avis:
      "Le dernier épisode de la trilogie de Christopher Nolan. Epoustouflant."
  },
  10930: {
    titre: "The Mask",
    image: "the_mask.jpg",
  ...
  11000: {
    ...
    acteurs:
      "Alain Chabat, Edouard Baer, Lucien Jean-Baptiste, Philippe Duquesne, Gérard Depardieu, Héléna Noguerra, Pierre Bénichou, Marthe Villalonga, Alex Lutz, Jérôme Commandeur, Rolland Courbis, Christiana Réali, Thierry Roland, Laurent Broomhead, Sophie Thalmann, Pierre Ménès, Nikos Aliagas",
    synopsis:
  ...
  11700: {
    ...
    acteurs:
      "Vera Miakicheva, Viktor Bazanov, Guennadi Logounov, Isolda Solodova",
    ...
    return (
      <div>
        <Helmet>
          ...
          <meta
            name="keywords"
            content="Guillaume Queste developpeur web portfolio projet react details film"
          />
          ...
          <meta
            property="og:url"
            content="http://cinema.guillaumequeste.fr/film/"
          />
          <meta
            property="og:image"
        ...
        <div className="fiche">
          <div className="image">
            <div className="divImage">
              <img
                src={requireImage(films[this.props.match.params.id].image)}
                className="tailleImage"
                alt={this.props.match.params.titre}
              />
            </div>
          </div>
          <div className="description">
            <div className="divDescription">
              <h2 className="titreCard">
                {films[this.props.match.params.id].titre}
              </h2>
              <ul>
                <li className="liCard">
                  <strong>Titre : </strong>
                ...
                <li className="liCard">
                  <strong>Genre : </strong>
                  {films[this.props.match.params.id].genre}
                </li>
                <li className="liCard">
                  <strong>Année : </strong>
                  {films[this.props.match.params.id].annee}
                </li>
                <li className="liCard">
                  <strong>Réalisateur : </strong>
                  {films[this.props.match.params.id].realisateur}
                </li>
                <li className="liCard">
                  <strong>Acteurs : </strong>
                  {films[this.props.match.params.id].acteurs}
                </li>
                <li className="liCard">
                  <strong>Synopsis : </strong>
                  {films[this.props.match.params.id].synopsis}
                </li>
                <li className="liCard">
                  <strong>Avis : </strong>
                  {films[this.props.match.params.id].avis}
                </li>
              </ul>
            </div>
          </div>
